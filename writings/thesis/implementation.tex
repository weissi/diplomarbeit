...
extensions have been used: \JWhsExt{BangPatterns},
\JWhsExt{ScopedTypeVariables}, \JWhsExt{Rank2Types}, and
\JWhsExt{FlexibleContexts}.  The automatically generated code by
\JWbinary{hprotoc} (\JWTprotobuf{} parsing) additionally uses
\JWhsExt{DeriveDataTypeable}, \JWhsExt{FlexibleInstances}, and
\JWhsExt{MultiParamTypeClasses}. The code should therefore be compilable by any
