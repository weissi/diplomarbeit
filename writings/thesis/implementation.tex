...
\JWbinary{hprotoc} that comes with the \JWThaskell{} \JWTprotobuf{} library
...
code can be found in the directory \JWpath{gen-src/} in this thesis' source
tree.
...
\JWcmd{cabal install --only-dependencies}
...
\JWcmd{(echo [1]; echo [1 0 1]; echo [1 0 1 0 1]) > /tmp/my-poly}
...
\JWcmd{run-evaluation.sh /tmp/my-polynomial.txt '[1 0 1 1 1 0 1]'}
...
\JWcmd{AllInOne /tmp/my-polynomial.txt '[1 0 1 1 1 0 1]'}
