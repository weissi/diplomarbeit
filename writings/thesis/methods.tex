...
Decoding well--formed DRAVs using any other decoding function will lead to
$\bot$ because the well--formed DRAV looks non--well--formed to the other
decoding function.
...
construction also assures that the MAC is checked by rendering all illicit
