...
only proven for Oblivious Polynomial Evaluation and the implementation expects
...
Since DRACs that evaluated polynomial always have exactly one final DRAE which
yields the function's result, the annotated maximal degree of this DRAE is the
degree of the function the DRAC encodes. Before evaluating a DRAC, \JWpTwo{} has
to verify the degree of the polynomial it is supposed to evaluate equals the
parametrized degree.
